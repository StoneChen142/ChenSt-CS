...
notMovingDown = pygame.transform.scale(pygame.image.load('PacManDown2.png'), (36, 36))
notMovingUp = pygame.transform.scale(pygame.image.load('PacManUp2.png'), (36, 36))
notMovingLeft = pygame.transform.scale(pygame.image.load('PacManLeft2.png'), (36, 36))
notMovingRight = pygame.transform.scale(pygame.image.load('PacManRight2.png'), (36, 36))

ShadowRight = [pygame.transform.scale(pygame.image.load('ShadowDown1.png'), (36, 36)), pygame.transform.scale(pygame.image.load('ShadowDown2.png'), (36, 36))]
ShadowLeft = [pygame.transform.scale(pygame.image.load('ShadowUp1.png'), (36, 36)), pygame.transform.scale(pygame.image.load('ShadowUp2.png'), (36, 36))]
ShadowUp = [pygame.transform.scale(pygame.image.load('ShadowLeft1.png'), (36, 36)), pygame.transform.scale(pygame.image.load('ShadowLeft2.png'), (36, 36))]
ShadowDown = [pygame.transform.scale(pygame.image.load('ShadowRight1.png'), (36, 36)), pygame.transform.scale(pygame.image.load('ShadowRight2.png'), (36, 36))]
